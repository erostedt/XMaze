XMaze is a maze generator and solver written in c++. The maze is visualized using xlib which is the only dependency. See examples on how to use this library
